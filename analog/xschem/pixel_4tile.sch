...
N -100 -80 -20 -80 {lab=row_off_detect_bot[63:0]}
N -100 -60 -20 -60 {lab=row_on_detect_bot[63:0]}
...
N 40 -760 40 -680 {lab=col_event_rst_top_left[63:0]}
N 60 -760 60 -680 {lab=array_col_top_left[63:0]}
N 340 -760 340 -680 {lab=col_event_rst_top_right[63:0]}
N 360 -760 360 -680 {lab=array_col_top_right[63:0]}
N 120 20 120 100 {lab=array_col_bot_left[63:0]}
N 140 20 140 100 {lab=col_event_rst_bot_left[63:0]}
N 420 20 420 100 {lab=array_col_bot_right[63:0]}
N 440 20 440 100 {lab=col_event_rst_bot_right[63:0]}
...
C {lab_wire.sym} -90 -80 0 0 {name=p16 sig_type=std_logic lab=row_off_detect_bot[63:0]}
C {lab_wire.sym} -90 -60 0 0 {name=p17 sig_type=std_logic lab=row_on_detect_bot[63:0]}
C {lab_wire.sym} 80 -700 3 1 {name=p18 sig_type=std_logic lab=dac_config_0}
C {lab_wire.sym} 40 -700 3 1 {name=p25 sig_type=std_logic lab=col_event_rst_top_left[63:0]}
C {lab_wire.sym} 60 -700 3 1 {name=p24 sig_type=std_logic lab=array_col_top_left[63:0]}
C {lab_wire.sym} 340 -700 3 1 {name=p26 sig_type=std_logic lab=col_event_rst_top_right[63:0]}
C {lab_wire.sym} 360 -700 3 1 {name=p27 sig_type=std_logic lab=array_col_top_right[63:0]}
C {lab_wire.sym} 140 40 3 0 {name=p28 sig_type=std_logic lab=col_event_rst_bot_left[63:0]}
C {lab_wire.sym} 120 40 3 0 {name=p29 sig_type=std_logic lab=array_col_bot_left[63:0]}
C {lab_wire.sym} 440 40 3 0 {name=p30 sig_type=std_logic lab=col_event_rst_bot_right[63:0]}
C {lab_wire.sym} 420 40 3 0 {name=p31 sig_type=std_logic lab=array_col_bot_right[63:0]}
...
C {iopin.sym} -400 -120 0 1 {name=p44 lab=row_off_detect_bot[63:0]}
C {iopin.sym} -400 -100 0 1 {name=p45 lab=row_on_detect_bot[63:0]}
...
C {iopin.sym} -400 -280 0 1 {name=p56 lab=array_col_top_left[63:0]}
C {iopin.sym} -400 -260 0 1 {name=p57 lab=array_col_top_right[63:0]}
C {iopin.sym} -400 -80 0 1 {name=p58 lab=array_col_bot_left[63:0]}
C {iopin.sym} -400 -60 0 1 {name=p59 lab=array_col_bot_right[63:0]}
C {iopin.sym} -400 -240 0 1 {name=p60 lab=col_event_rst_top_left[63:0]}
C {iopin.sym} -400 -220 0 1 {name=p61 lab=col_event_rst_top_right[63:0]}
C {iopin.sym} -400 -40 0 1 {name=p62 lab=col_event_rst_bot_left[63:0]}
C {iopin.sym} -400 -20 0 1 {name=p63 lab=col_event_rst_bot_right[63:0]}
