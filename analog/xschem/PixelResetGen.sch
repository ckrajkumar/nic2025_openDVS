...
N 700 -710 730 -710 {lab=GndA}
N 700 -760 700 -740 {lab=nRst}
N 700 -810 730 -810 {lab=VddA18}
N 620 -810 660 -810 {lab=RefrBp}
N 700 -760 880 -760 {lab=nRst}
N 700 -780 700 -760 {lab=nRst}
N 880 -760 880 -740 {lab=nRst}
N 850 -700 850 -660 {lab=VddA18}
N 880 -660 910 -660 {lab=VddA18}
N 880 -700 880 -660 {lab=VddA18}
N 850 -660 880 -660 {lab=VddA18}
N 910 -700 910 -660 {lab=VddA18}
N 620 -580 660 -580 {lab=rowRst}
N 700 -580 730 -580 {lab=GndA}
N 700 -880 700 -840 {lab=VddA18}
N 700 -550 700 -500 {lab=GndA}
...
C {lab_wire.sym} 730 -580 0 0 {name=p52 sig_type=std_logic lab=GndA}
C {iopin.sym} 700 -500 1 0 {name=p61 lab=GndA}
C {iopin.sym} 700 -880 3 0 {name=p62 lab=VddA18
}
C {iopin.sym} 920 -760 0 0 {name=p2 lab=nRst}
C {lab_wire.sym} 730 -710 0 0 {name=p3 sig_type=std_logic lab=GndA}
C {lab_wire.sym} 730 -810 0 0 {name=p4 sig_type=std_logic lab=VddA18}
