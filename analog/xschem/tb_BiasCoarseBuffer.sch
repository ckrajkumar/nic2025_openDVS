...
N 590 -460 590 -330 {lab=BiasCB<0>}
N 530 -460 530 -330 {lab=BiasCB<2>}
N 500 -460 500 -330 {lab=BiasCB<3>}
N 440 -460 440 -330 {lab=BiasCB<5>}
N 380 -460 380 -330 {lab=BiasCB<7>}
...
N 560 -460 560 -330 {lab=BiasCB<1>}
N 470 -460 470 -330 {lab=BiasCB<4>}
N 410 -460 410 -330 {lab=BiasCB<6>}
...
N 590 -270 590 -220 {lab=#net1}
N 590 -220 650 -220 {lab=#net1}
N 560 -270 560 -200 {lab=#net2}
N 560 -200 650 -200 {lab=#net2}
N 530 -270 530 -180 {lab=#net3}
N 530 -180 650 -180 {lab=#net3}
N 500 -270 500 -160 {lab=#net4}
N 500 -160 650 -160 {lab=#net4}
N 470 -270 470 -140 {lab=#net5}
N 470 -140 650 -140 {lab=#net5}
N 440 -270 440 -120 {lab=#net6}
N 440 -120 650 -120 {lab=#net6}
N 410 -270 410 -100 {lab=#net7}
N 410 -100 650 -100 {lab=#net7}
N 380 -270 380 -80 {lab=#net8}
N 380 -80 650 -80 {lab=#net8}
...
C {code_shown.sym} -180 -470 0 0 {name=NGSPICE
only_toplevel=true
value="
.param xvdd = 1.8
.param xpowerdown = 0
...
C {vsource.sym} 590 -300 0 1 {name=Vmeas_BiasCB0 value=0 savecurrent=true}
C {vsource.sym} 560 -300 0 1 {name=Vmeas_BiasCB1 value=0 savecurrent=true}
C {vsource.sym} 530 -300 0 1 {name=Vmeas_BiasCB2 value=0 savecurrent=true}
C {vsource.sym} 500 -300 0 1 {name=Vmeas_BiasCB3 value=0 savecurrent=true}
C {vsource.sym} 470 -300 0 1 {name=Vmeas_BiasCB4 value=0 savecurrent=true}
C {vsource.sym} 440 -300 0 1 {name=Vmeas_BiasCB5 value=0 savecurrent=true}
C {vsource.sym} 410 -300 0 1 {name=Vmeas_BiasCB6 value=0 savecurrent=true}
C {vsource.sym} 380 -300 0 1 {name=Vmeas_BiasCB7 value=0 savecurrent=true}
