...
N 270 -180 270 -160 {lab=VMasterBiasN}
N 570 -180 720 -180 {lab=VMasterBiasN}
N 720 -180 720 -160 {lab=VMasterBiasN}
N 570 -180 570 -160 {lab=VMasterBiasN}
N 470 -180 570 -180 {lab=VMasterBiasN}
N 430 -180 430 -160 {lab=VMasterBiasN}
N 270 -180 430 -180 {lab=VMasterBiasN}
N 430 -180 470 -180 {lab=VMasterBiasN}
N 270 -100 270 -60 {lab=GndA}
N 430 -100 430 -60 {lab=GndA}
N 570 -100 570 -60 {lab=GndA}
N 720 -100 720 -60 {lab=GndA}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 270 -130 0 0 {name=C1 model=cap_mim_m3_1 W=43.7 L=145 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 430 -130 0 0 {name=C3 model=cap_mim_m3_1 W=30 L=145 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 570 -130 0 0 {name=C4 model=cap_mim_m3_1 W=30 L=145 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 720 -130 0 0 {name=C5 model=cap_mim_m3_1 W=30 L=145 MF=1 spiceprefix=X}
C {lab_wire.sym} 270 -60 3 1 {name=p28 sig_type=std_logic lab=GndA}
C {lab_wire.sym} 430 -60 3 1 {name=p31 sig_type=std_logic lab=GndA}
C {lab_wire.sym} 570 -60 3 1 {name=p32 sig_type=std_logic lab=GndA}
C {lab_wire.sym} 720 -60 3 1 {name=p34 sig_type=std_logic lab=GndA}
