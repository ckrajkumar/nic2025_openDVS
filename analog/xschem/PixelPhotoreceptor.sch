...
C {lab_wire.sym} -30 -330 0 1 {name=p17 sig_type=std_logic lab=gnd}
...
C {lab_wire.sym} 270 -200 0 0 {name=p25 sig_type=std_logic lab=gnd}
C {lab_wire.sym} 270 -460 0 0 {name=p26 sig_type=std_logic lab=vdd}
...
C {iopin.sym} 90 -60 1 0 {name=p1 lab=gnd
}
