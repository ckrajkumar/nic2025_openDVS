...
N 1220 -250 1250 -250 {lab=gnd}
N 1220 -340 1250 -340 {lab=gnd}
N 920 -340 950 -340 {lab=gnd}
...
C {lab_wire.sym} 1220 -180 0 0 {name=p40 sig_type=std_logic lab=gnd}
C {iopin.sym} 1070 -520 3 0 {name=p42 lab=readLine}
C {lab_wire.sym} 950 -250 0 0 {name=p43 sig_type=std_logic lab=gnd}
C {lab_wire.sym} 1250 -250 0 0 {name=p44 sig_type=std_logic lab=gnd}
C {lab_wire.sym} 1250 -340 0 0 {name=p45 sig_type=std_logic lab=gnd}
...
C {lab_wire.sym} 950 -340 0 0 {name=p50 sig_type=std_logic lab=gnd}
C {iopin.sym} 790 -250 2 0 {name=p2 lab=ON}
C {iopin.sym} 1100 -250 2 0 {name=p9 lab=nOFF}
C {iopin.sym} 920 -180 1 0 {name=p10 lab=gnd
}
