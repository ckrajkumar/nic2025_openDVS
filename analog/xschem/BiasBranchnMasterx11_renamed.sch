...
N 430 -600 490 -600 {lab=Bias[10:0]}
...
N -160 -270 60 -270 {lab=CoarseOneHot[87:77]}
N -160 -110 60 -110 {lab=LowBiasInterfaceEn[10:0]}
N -160 -30 60 -30 {lab=BIT0[10:0]}
N -160 -50 60 -50 {lab=PowerDown[10:0]}
N -160 -590 60 -590 {lab=FineCode[87:77]}
N -160 -430 60 -430 {lab=nFineCode[87:77]}
N -160 -10 60 -10 {lab=NBiasEn[10:0]}
N -160 10 60 10 {lab=PBiasEn[10:0]}
N -160 50 60 50 {lab=BiasDisabled[10:0]}
N -160 -250 60 -250 {lab=CoarseOneHot[76:66]}
N -160 -230 60 -230 {lab=CoarseOneHot[65:55]}
N -160 -210 60 -210 {lab=CoarseOneHot[54:44]}
N -160 -190 60 -190 {lab=CoarseOneHot[43:33]}
N -160 -170 60 -170 {lab=CoarseOneHot[32:22]}
N -160 -150 60 -150 {lab=CoarseOneHot[21:11]}
N -160 -130 60 -130 {lab=CoarseOneHot[10:0]}
N -160 -410 60 -410 {lab=nFineCode[76:66]}
N -160 -390 60 -390 {lab=nFineCode[65:55]}
N -160 -370 60 -370 {lab=nFineCode[54:44]}
N -160 -350 60 -350 {lab=nFineCode[43:33]}
N -160 -330 60 -330 {lab=nFineCode[32:22]}
N -160 -310 60 -310 {lab=nFineCode[21:11]}
N -160 -570 60 -570 {lab=FineCode[76:66]}
N -160 -550 60 -550 {lab=FineCode[65:55]}
N -160 -530 60 -530 {lab=FineCode[54:44]}
N -160 -510 60 -510 {lab=FineCode[43:33]}
N -160 -490 60 -490 {lab=FineCode[32:22]}
N -160 -470 60 -470 {lab=FineCode[21:11]}
N -160 -450 60 -450 {lab=FineCode[10:0]}
N -160 -290 60 -290 {lab=nFineCode[10:0]}
...
C {lab_wire.sym} 490 -600 0 0 {name=p9 sig_type=std_logic lab=Bias[10:0]}
C {ipin.sym} -280 -500 2 1 {name=p6 lab=FineCodeBuffer[7:0]}
C {lab_wire.sym} -160 -590 0 1 {name=p28 sig_type=std_logic lab=FineCode[87:77]}
C {lab_wire.sym} -160 -970 0 1 {name=p33 sig_type=std_logic lab=FineCodeBuffer[7:0]}
C {lab_wire.sym} -160 -430 0 1 {name=p39 sig_type=std_logic lab=nFineCode[87:77]}
...
C {lab_wire.sym} -160 -270 0 1 {name=p60 sig_type=std_logic lab=CoarseOneHot[87:77]}
...
C {lab_wire.sym} -160 50 0 1 {name=p65 sig_type=std_logic lab=BiasDisabled[10:0]}
...
C {lab_wire.sym} -160 -250 0 1 {name=p70 sig_type=std_logic lab=CoarseOneHot[76:66]}
C {lab_wire.sym} -160 -230 0 1 {name=p71 sig_type=std_logic lab=CoarseOneHot[65:55]}
C {lab_wire.sym} -160 -210 0 1 {name=p72 sig_type=std_logic lab=CoarseOneHot[54:44]}
C {lab_wire.sym} -160 -190 0 1 {name=p73 sig_type=std_logic lab=CoarseOneHot[43:33]}
C {lab_wire.sym} -160 -170 0 1 {name=p74 sig_type=std_logic lab=CoarseOneHot[32:22]}
C {lab_wire.sym} -160 -150 0 1 {name=p77 sig_type=std_logic lab=CoarseOneHot[21:11]}
C {lab_wire.sym} -160 -130 0 1 {name=p78 sig_type=std_logic lab=CoarseOneHot[10:0]}
C {lab_wire.sym} -160 -410 0 1 {name=p79 sig_type=std_logic lab=nFineCode[76:66]}
C {lab_wire.sym} -160 -390 0 1 {name=p80 sig_type=std_logic lab=nFineCode[65:55]}
C {lab_wire.sym} -160 -370 0 1 {name=p81 sig_type=std_logic lab=nFineCode[54:44]}
C {lab_wire.sym} -160 -350 0 1 {name=p82 sig_type=std_logic lab=nFineCode[43:33]}
C {lab_wire.sym} -160 -330 0 1 {name=p83 sig_type=std_logic lab=nFineCode[32:22]}
C {lab_wire.sym} -160 -310 0 1 {name=p84 sig_type=std_logic lab=nFineCode[21:11]}
C {lab_wire.sym} -160 -570 0 1 {name=p86 sig_type=std_logic lab=FineCode[76:66]}
C {lab_wire.sym} -160 -550 0 1 {name=p87 sig_type=std_logic lab=FineCode[65:55]}
C {lab_wire.sym} -160 -530 0 1 {name=p88 sig_type=std_logic lab=FineCode[54:44]}
C {lab_wire.sym} -160 -510 0 1 {name=p89 sig_type=std_logic lab=FineCode[43:33]}
C {lab_wire.sym} -160 -490 0 1 {name=p93 sig_type=std_logic lab=FineCode[32:22]}
C {lab_wire.sym} -160 -470 0 1 {name=p94 sig_type=std_logic lab=FineCode[21:11]}
C {lab_wire.sym} -160 -450 0 1 {name=p95 sig_type=std_logic lab=FineCode[10:0]}
C {lab_wire.sym} -160 -290 0 1 {name=p85 sig_type=std_logic lab=nFineCode[10:0]}
