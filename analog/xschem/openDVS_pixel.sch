...
N 600 -60 600 -30 {lab=vdd}
N 790 -60 790 -30 {lab=gnd}
N 820 -60 820 -30 {lab=vdd}
N 640 -130 730 -130 {lab=#net1}
...
C {iopin.sym} 140 -40 1 0 {name=p61 lab=gnd
}
C {iopin.sym} 170 -40 1 0 {name=p62 lab=vdd
}
...
C {lab_wire.sym} 370 -30 3 1 {name=p3 sig_type=std_logic lab=gnd}
C {lab_wire.sym} 400 -30 3 1 {name=p5 sig_type=std_logic lab=vdd}
C {PixelChangeAmplifier.sym} 660 -140 0 0 {name=xsf1}
...
C {lab_wire.sym} 570 -30 3 1 {name=p11 sig_type=std_logic lab=gnd}
C {lab_wire.sym} 600 -30 3 1 {name=p12 sig_type=std_logic lab=vdd}
...
C {lab_wire.sym} 790 -30 3 1 {name=p15 sig_type=std_logic lab=gnd}
C {lab_wire.sym} 820 -30 3 1 {name=p16 sig_type=std_logic lab=vdd}
...
C {lab_wire.sym} 280 270 3 1 {name=p20 sig_type=std_logic lab=gnd}
C {lab_wire.sym} 310 270 3 1 {name=p21 sig_type=std_logic lab=vdd}
...
C {lab_wire.sym} 740 280 3 1 {name=p4 sig_type=std_logic lab=gnd}
