...
N -160 -90 60 -90 {lab=nLowBiasInterfaceEn}
N -160 -70 60 -70 {lab=CoarseOneHotLowBiasEn}
N -160 -270 60 -270 {lab=CoarseOneHot[7]}
N -160 -110 60 -110 {lab=LowBiasInterfaceEn}
N -160 -30 60 -30 {lab=nLowBiasBuffEn}
N -160 -50 60 -50 {lab=LowBiasBuffEn}
N -160 -590 60 -590 {lab=FineCode[7]}
N -160 -430 60 -430 {lab=nFineCode[7]}
N -160 -10 60 -10 {lab=NBiasEn}
N -160 10 60 10 {lab=PBiasEn}
N -160 50 60 50 {lab=BiasDisable}
N -160 30 60 30 {lab=BiasEnable}
N -160 -250 60 -250 {lab=CoarseOneHot[6]}
N -160 -230 60 -230 {lab=CoarseOneHot[5]}
N -160 -210 60 -210 {lab=CoarseOneHot[4]}
N -160 -190 60 -190 {lab=CoarseOneHot[3]}
N -160 -170 60 -170 {lab=CoarseOneHot[2]}
N -160 -150 60 -150 {lab=CoarseOneHot[1]}
N -160 -130 60 -130 {lab=CoarseOneHot[0]}
N -160 -410 60 -410 {lab=nFineCode[6]}
N -160 -390 60 -390 {lab=nFineCode[5]}
N -160 -370 60 -370 {lab=nFineCode[4]}
N -160 -350 60 -350 {lab=nFineCode[3]}
N -160 -330 60 -330 {lab=nFineCode[2]}
N -160 -310 60 -310 {lab=nFineCode[1]}
N -160 -570 60 -570 {lab=FineCode[6]}
N -160 -550 60 -550 {lab=FineCode[5]}
N -160 -530 60 -530 {lab=FineCode[4]}
N -160 -510 60 -510 {lab=FineCode[3]}
N -160 -490 60 -490 {lab=FineCode[2]}
...
C {lab_wire.sym} -160 -590 0 1 {name=p28 sig_type=std_logic lab=FineCode[7]}
C {lab_wire.sym} -160 -970 0 1 {name=p33 sig_type=std_logic lab=FineCodeBuffer[7:0]}
C {lab_wire.sym} -160 -430 0 1 {name=p39 sig_type=std_logic lab=nFineCode[7]}
...
C {lab_wire.sym} -160 -110 0 1 {name=p57 sig_type=std_logic lab=LowBiasInterfaceEn}
C {lab_wire.sym} -160 -90 0 1 {name=p58 sig_type=std_logic lab=nLowBiasInterfaceEn}
C {lab_wire.sym} -160 -70 0 1 {name=p59 sig_type=std_logic lab=CoarseOneHotLowBiasEn}
C {lab_wire.sym} -160 -270 0 1 {name=p60 sig_type=std_logic lab=CoarseOneHot[7]}
C {lab_wire.sym} -160 -50 0 1 {name=p61 sig_type=std_logic lab=LowBiasBuffEn}
C {lab_wire.sym} -160 -30 0 1 {name=p62 sig_type=std_logic lab=nLowBiasBuffEn}
C {ipin.sym} -360 -740 2 1 {name=p3 lab=PowerDown}
C {lab_wire.sym} -160 -10 0 1 {name=p26 sig_type=std_logic lab=NBiasEn}
C {lab_wire.sym} -160 10 0 1 {name=p63 sig_type=std_logic lab=PBiasEn}
C {lab_wire.sym} -160 30 0 1 {name=p64 sig_type=std_logic lab=BiasEnable}
C {lab_wire.sym} -160 50 0 1 {name=p65 sig_type=std_logic lab=BiasDisable}
...
C {lab_wire.sym} -160 -250 0 1 {name=p70 sig_type=std_logic lab=CoarseOneHot[6]}
C {lab_wire.sym} -160 -230 0 1 {name=p71 sig_type=std_logic lab=CoarseOneHot[5]}
C {lab_wire.sym} -160 -210 0 1 {name=p72 sig_type=std_logic lab=CoarseOneHot[4]}
C {lab_wire.sym} -160 -190 0 1 {name=p73 sig_type=std_logic lab=CoarseOneHot[3]}
C {lab_wire.sym} -160 -170 0 1 {name=p74 sig_type=std_logic lab=CoarseOneHot[2]}
C {lab_wire.sym} -160 -150 0 1 {name=p77 sig_type=std_logic lab=CoarseOneHot[1]}
C {lab_wire.sym} -160 -130 0 1 {name=p78 sig_type=std_logic lab=CoarseOneHot[0]}
C {lab_wire.sym} -160 -410 0 1 {name=p79 sig_type=std_logic lab=nFineCode[6]}
C {lab_wire.sym} -160 -390 0 1 {name=p80 sig_type=std_logic lab=nFineCode[5]}
C {lab_wire.sym} -160 -370 0 1 {name=p81 sig_type=std_logic lab=nFineCode[4]}
C {lab_wire.sym} -160 -350 0 1 {name=p82 sig_type=std_logic lab=nFineCode[3]}
C {lab_wire.sym} -160 -330 0 1 {name=p83 sig_type=std_logic lab=nFineCode[2]}
C {lab_wire.sym} -160 -310 0 1 {name=p84 sig_type=std_logic lab=nFineCode[1]}
C {lab_wire.sym} -160 -570 0 1 {name=p86 sig_type=std_logic lab=FineCode[6]}
C {lab_wire.sym} -160 -550 0 1 {name=p87 sig_type=std_logic lab=FineCode[5]}
C {lab_wire.sym} -160 -530 0 1 {name=p88 sig_type=std_logic lab=FineCode[4]}
C {lab_wire.sym} -160 -510 0 1 {name=p89 sig_type=std_logic lab=FineCode[3]}
C {lab_wire.sym} -160 -490 0 1 {name=p93 sig_type=std_logic lab=FineCode[2]}
